...
from ..data.dynclass import Brain10, DynCSL, IMDB, UIHC, DBLP5, Reddit4, SFHH, LH10, InVS15
...
def main(*ARGS):
    ...
    datasetize = {
        ...
        "SFHH": SFHH, "LH10": LH10, "InVS15": InVS15
    }[source]
