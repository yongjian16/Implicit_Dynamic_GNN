...
from ...task.impdyn_engcovid import ImpDynModelReg
...
def main(*ARGS):
    ...
    desc = (
        identifier(
            ...
            patience=str(patience), seed=str(seed), args=args,
        )
    )
    ...
    metaset = (
        dataset.asto_dynamic_adjacency_list_dynamic_edge(
            window_history_size=winsize, window_future_size=1, win_aggr=win_aggr,
